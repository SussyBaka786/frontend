...
function PilotSchedule() {
  ...
  const onUpdate = async (updatedBookingData) => {
    Swal.fire({
      title: "",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // const pilotBookings = fetchedBookings.filter(pbooking => {
        //   return pbooking.assigned_pilot && pbooking.assigned_pilot._id === id;
        // });
