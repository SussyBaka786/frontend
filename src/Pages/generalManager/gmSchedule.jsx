...
function GeneralSchedules() {
  ...
  return (
    <main className="super-admin-table-container">
      ...
      <div className="super-admin-booking-table-container">
      <div className="booking-table-controls">
        ...
        {totalPages > 1 && (
          <div className="super-admin-booking-pagination">
            <button
            ...
            {[...Array(totalPages)].map((_, pageIndex) => (
              <button
                ...
                className={currentPage === pageIndex + 1 ? "super-admin-active-page" : ""}
              >
                {pageIndex + 1}
              </button>
            ))}
        ...
        <p className="super-admin-booking-results-count">{bookings.length} Results</p>
      </div>
